...
from Alumnos.forms import Busqueda_legajo_dni, Busqueda_legajo_apellido, Busqueda_legajo_legajo, Nuevo_alumno, Mover_legajo_lugar, Mover_legajo_archivo, Mover_legajo_cajon, Nuevo_archivo, Nuevo_lugar
